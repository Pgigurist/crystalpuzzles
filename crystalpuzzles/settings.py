"""
Django settings for crystalpuzzles project.
...
SECRET_KEY = '&qu1$b*e8h2+#-y7fb@&a(cwikg8+-_^opr*vz8fwsns&#xxi5'
...
ROOT_URLCONF = 'crystalpuzzles.urls'
...
WSGI_APPLICATION = 'crystalpuzzles.wsgi.application'
